...
type ClusterAccessResponseStatus struct {
	...
	// conditions represent the current state of the ClusterAccessResponse resource.
...
type ClusterAccessResponse struct {
	...
	// +optional
	Status ClusterAccessResponseStatus `json:"status,omitzero"`
}

// +kubebuilder:object:root=true

// ClusterAccessResponseList contains a list of ClusterAccessResponse
type ClusterAccessResponseList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []ClusterAccessResponse `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ClusterAccessResponse{}, &ClusterAccessResponseList{})
}
