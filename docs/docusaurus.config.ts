    ...
    [
      'classic',
      {
        ...
        docs: {
          ...
          editUrl:
            'https://github.com/itsthatdude/kairos/tree/main/docs/',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/itsthatdude/kairos',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      style: 'dark',
      copyright: `Copyright © ${new Date().getFullYear()} Kairos, Inc. Built with Docusaurus.`,
    },
    prism: {
