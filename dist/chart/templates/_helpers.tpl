...
*/}}
{{- define "jit-access-controller.name" -}}
...
*/}}
{{- define "jit-access-controller.fullname" -}}
...
*/}}
{{- define "jit-access-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "jit-access-controller.resourceName" -}}
{{- $fullname := include "jit-access-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "jit-access-controller.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "jit-access-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
