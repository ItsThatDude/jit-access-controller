...
var _ = Describe("GenericJITAccessReconciler with envtest", func() {
	...
	It("should create a pending ClusterJITAccessRequest and update status", func() {
		...
		waitForCreated(ctx, k8sClient, client.ObjectKeyFromObject(requestObj), &v1alpha1.ClusterJITAccessRequest{})
		...
		Eventually(func() (requestStatus, error) {
			updated := &v1alpha1.ClusterJITAccessRequest{}
		...
		waitForMarkedForDeletion(ctx, k8sClient, client.ObjectKeyFromObject(requestObj), &v1alpha1.ClusterJITAccessRequest{})

		reconcileOnce(ctx, reconciler, client.ObjectKeyFromObject(requestObj))
		waitForDeleted(ctx, k8sClient, client.ObjectKeyFromObject(requestObj), &v1alpha1.ClusterJITAccessRequest{})
	})

	It("should cleanup deleted ClusterJITAccessRequest and remove finalizer", func() {
