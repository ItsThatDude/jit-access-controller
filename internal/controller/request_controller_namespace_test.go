...
var _ = Describe("JITAccessReconciler with envtest", func() {
	...
	AfterEach(func() {
		...
		waitForDeleted(ctx, k8sClient, client.ObjectKeyFromObject(policyObj), &v1alpha1.AccessPolicy{})
	})
	...
	It("should create grant for approved AccessRequest", func() {
		...
		waitForCreated(ctx, k8sClient, client.ObjectKey{Namespace: reconciler.SystemNamespace, Name: requestObj.Name}, &v1alpha1.AccessGrant{})
